...
class PortalEstudianteController extends Controller
{
    ...
    {
        return (new \App\Services\MinerdBoletinService())->build($matricula, $schoolYear);
    }
    ...
    public function planEvaluacion()
    {
        ...
        return view('portal.estudiante.plan_evaluacion', compact(
    ...
    public function registroMinerd()
    {
        $estudiante = $this->getEstudiante();
        $schoolYear = SchoolYear::actual();
        ...
        return view('portal.estudiante.registro_minerd', compact(
