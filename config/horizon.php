...
return [
    ...
    */
    ...
    'defaults' => [
        // Tiempo real: push notifications + WhatsApp (máxima prioridad)
        'supervisor-realtime' => [
            'connection'   => 'redis',
        ...
        // Google Classroom / ZuraClass sync
        ...
        // PDFs y exports pesados (baja prioridad, timeout largo)
        'supervisor-heavy' => [
            'connection'   => 'redis',
            'queue'        => ['pdfs', 'exports'],
            'balance'      => false,
    ...
    'environments' => [
        ...
        'local' => [
            ...
            'supervisor-classroom' => ['maxProcesses' => 1],
            'supervisor-sigerd'    => ['maxProcesses' => 1],
