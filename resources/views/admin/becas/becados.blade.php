    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.becas.reporte-excel') }}"
               class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-green-300 text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 transition dark:bg-green-900/20 dark:text-green-400 dark:border-green-700">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
