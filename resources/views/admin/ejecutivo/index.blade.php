    ...
    <div class="card-body py-3 px-4 text-white">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2 flex-wrap align-items-center">
                ...
                <a href="{{ route('admin.ejecutivo.pdf') }}" target="_blank"
    ...
    <div class="col-6 col-lg-3">
        <div class="kpi-card" style="background:linear-gradient(135deg,#065f46,#059669);">
            ...
            <div>
                ...
                <div class="kpi-sub">{{ $tasaAprobacion }}% aprobación</div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
    ...
    <div class="col-6 col-lg-3">
        ...
        <div class="kpi-card" style="background:linear-gradient(135deg,#155e75,#0891b2);">
            ...
            <div>
                ...
                <div class="kpi-sub">{{ $rendimiento->sum('total_aprobados') }} aprobados</div>
            </div>
        </div>
        @endif
    </div>
...
{{-- ── Row 5: Disciplina + Pre-matrícula ───────────────────────────── --}}
<div class="row g-3 mb-3">
...
new Chart(document.getElementById('chartAsistencia'), {
    ...
    data: {
        ...
        datasets: [
            {
                label: 'Presentes', data: asistPresente,
                borderColor: '#16a34a', backgroundColor: '#16a34a22',
                tension: .3, fill: true, pointRadius: 4, pointBackgroundColor: '#16a34a',
            },
            {
                label: 'Tardanzas', data: asistTardanza,
                borderColor: '#d97706', backgroundColor: 'transparent',
                tension: .3, fill: false, pointRadius: 4, pointBackgroundColor: '#d97706',
                borderDash: [4, 3],
            },
            {
                label: 'Ausentes', data: asistAusente,
                borderColor: '#dc2626', backgroundColor: '#dc262622',
                tension: .3, fill: true, pointRadius: 4, pointBackgroundColor: '#dc2626',
            }
        ]
    },
    options: {
            ...
            tooltip: {
                callbacks: {
                    label: ctx => {
                        ...
                        return ` ${ctx.label}: RD$${val.toLocaleString('es-DO', {minimumFractionDigits:0})}`;
                    }
                }
            }
        }
...
@else
// ── 4b. Matrículas donut cuando no hay pagos ──────────────────────────────
new Chart(document.getElementById('chartMatriculas'), {
    ...
    data: {
        ...
        datasets: [{
            data: matriculaData,
            backgroundColor: ['#2563eb','#16a34a','#d97706','#dc2626','#7c3aed','#0891b2','#be185d','#6b7280'],
            borderWidth: 2, borderColor: '#fff',
        }]
    },
    options: {
