...
@section('page-title', 'Editar Malla')

@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-0" style="color:#1e3a6e;"><i class="bi bi-grid-3x3 me-2"></i>Editar Entrada de Malla</h4>
...
<div class="card border-0 shadow-sm" style="max-width:680px;">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('admin.malla.update', $malla) }}">
            @csrf @method('PUT')
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <form method="POST" action="{{ route('admin.malla.destroy', $malla) }}"
                      onsubmit="return confirm('¿Eliminar esta entrada?')" class="ms-auto">
                    @csrf @method('DELETE')
