...
@section('page-title', 'Editar Año Escolar')
...
<div class="d-flex align-items-center mb-4 gap-3">
    ...
    <h4 class="fw-bold mb-0" style="color:var(--primary)">
        <i class="bi bi-mortarboard me-2"></i>Editar: {{ $schoolYear->nombre }}
    </h4>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        ...
        <div class="d-flex gap-3 mb-4 p-3 rounded" style="background:#f8faff;border:1px solid #e5e7eb;">
            <div class="text-center px-3">
                <div class="fw-bold" style="color:var(--primary);">{{ $schoolYear->grupos_count }}</div>
                <div class="text-muted" style="font-size:.72rem;">Grupos</div>
            </div>
            <div class="text-center px-3">
                <div class="fw-bold" style="color:var(--primary);">{{ $schoolYear->periodos_count }}</div>
        ...
        <form method="POST" action="{{ route('admin.school-years.update', $schoolYear) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                       value="{{ old('nombre', $schoolYear->nombre) }}" required>
            ...
            <div class="row g-3 mb-3">
                <div class="col-sm-6">
                    ...
                    <input type="date" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror"
                           value="{{ old('fecha_inicio', $schoolYear->fecha_inicio?->format('Y-m-d')) }}" required>
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" name="fecha_fin" class="form-control @error('fecha_fin') is-invalid @enderror"
                           value="{{ old('fecha_fin', $schoolYear->fecha_fin?->format('Y-m-d')) }}" required>
            ...
            <div class="mb-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="activo" id="activo" value="1"
                           {{ old('activo', $schoolYear->activo) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold" for="activo">Año Activo</label>
                </div>
            </div>
