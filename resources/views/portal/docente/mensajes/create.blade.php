...
<div class="d-flex align-items-center gap-2 mb-4">
    <a href="{{ route('portal.docente.mensajes.index') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-body px-4 py-4">
                ...
                <form method="POST" action="{{ route('portal.docente.mensajes.store') }}">
                    @csrf
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('portal.docente.mensajes.index') }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
