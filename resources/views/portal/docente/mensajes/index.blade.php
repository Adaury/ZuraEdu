...
@section('sidebar')
    @include('portal.docente._sidebar_clase', ['activeKey' => 'mensajes'])
@endsection
...
@section('bottom-nav')
    ...
    <a href="{{ route('portal.docente.mensajes.index') }}" class="prt-nav-item active">
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <small class="text-muted">Bandeja de mensajes internos</small>
    </div>
    <a href="{{ route('portal.docente.mensajes.create') }}" class="btn btn-primary btn-sm">
...
<ul class="nav nav-tabs mb-3">
    <li class="nav-item">
        <a class="nav-link {{ $tab === 'recibidos' ? 'active' : '' }}"
           href="{{ route('portal.docente.mensajes.index', ['tab' => 'recibidos']) }}">
    ...
    <li class="nav-item">
        <a class="nav-link {{ $tab === 'enviados' ? 'active' : '' }}"
           href="{{ route('portal.docente.mensajes.index', ['tab' => 'enviados']) }}">
        ...
        <div class="list-group list-group-flush">
            ...
            @php
                if ($tab === 'recibidos') {
                    ...
                    $link  = route('portal.docente.mensajes.show', $msg);
                } else {
                    $msg   = $item;
                    $leido = true;
