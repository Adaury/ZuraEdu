...
@section('sidebar')
    @include('portal.estudiante._sidebar', ['activeKey' => 'planificaciones'])
@endsection
...
@section('bottom-nav')
    ...
    <a href="{{ route('portal.estudiante.planificaciones') }}" class="prt-nav-item active">
...
<div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1rem;flex-wrap:wrap;">
    ...
    <div style="display:flex;gap:.5rem;">
        <a href="{{ route('portal.estudiante.planificaciones.pdf') }}" target="_blank"
           style="background:#dc2626;color:#fff;border-radius:8px;padding:.4rem .85rem;font-size:.78rem;font-weight:600;text-decoration:none;display:flex;align-items:center;gap:.4rem;white-space:nowrap;">
            <i class="bi bi-file-earmark-pdf"></i>PDF
        </a>
        <a href="{{ route('portal.estudiante.planificaciones.excel') }}"
           style="background:#15803d;color:#fff;border-radius:8px;padding:.4rem .85rem;font-size:.78rem;font-weight:600;text-decoration:none;display:flex;align-items:center;gap:.4rem;white-space:nowrap;">
...
<div class="prt-card" style="text-align:center;padding:3rem 1rem;">
    ...
    <div style="font-size:.8rem;color:#94a3b8;">Aún no hay planificaciones publicadas para tu sección.</div>
</div>
@else
