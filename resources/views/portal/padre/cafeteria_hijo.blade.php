...
@section('title', 'Cafetería — ' . $estudiante->nombres)

@section('sidebar')
    @include('portal.padre._sidebar', ['activeKey' => 'cafeteria', 'estudiante' => $estudiante])
@endsection
...
<div class="mb-4 p-4" style="background:linear-gradient(135deg,#7c3aed,#a78bfa);border-radius:16px;position:relative;overflow:hidden;">
    ...
    <div style="position:relative;z-index:1;">
        <h4 class="text-white fw-bold mb-1"><i class="bi bi-cup-hot-fill me-2"></i>Saldo Cafetería</h4>
...
<div class="alert py-3 mb-4" style="background:#fef2f2;border:1px solid #fca5a5;border-radius:12px;">
    <div class="d-flex align-items-start gap-2">
        ...
        <div>
            ...
            <div style="font-size:.82rem;color:#7f1d1d;">El saldo de su hijo/a es negativo. Por favor solicite una recarga en la administración.</div>
        </div>
    </div>
</div>
@endif
