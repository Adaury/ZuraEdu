...
@section('sidebar')
    @include('portal.padre._sidebar', ['activeKey' => 'comunicados'])
@endsection
...
@section('bottom-nav')
    ...
    <a href="{{ route('portal.padre.comunicados') }}" class="prt-nav-item active">
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
    ...
    <div style="display:flex;align-items:center;gap:.5rem;">
        ...
        <a href="{{ route('portal.padre.comunicados.pdf') }}" target="_blank"
           style="background:#991b1b;color:#fff;border-radius:7px;padding:.25rem .65rem;font-size:.72rem;font-weight:700;text-decoration:none;display:flex;align-items:center;gap:.3rem;">
            <i class="bi bi-file-earmark-pdf-fill"></i>PDF
        </a>
        <a href="{{ route('portal.padre.comunicados.excel') }}"
           style="background:#15803d;color:#fff;border-radius:7px;padding:.25rem .65rem;font-size:.72rem;font-weight:700;text-decoration:none;display:flex;align-items:center;gap:.3rem;">
...
<div class="prt-card" style="margin-bottom:.85rem;">
    <div class="prt-card-body" style="padding:.9rem 1.1rem;">
        ...
        <div style="font-size:.8rem;color:#374151;line-height:1.65;margin-bottom:.5rem;" class="comunicado-body">{!! nl2br(e($com->cuerpo)) !!}</div>
