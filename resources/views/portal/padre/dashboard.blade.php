...
<script>
function verComunicado(id,titulo,cuerpo,fecha){document.getElementById('comTitulo').textContent=titulo;document.getElementById('comFecha').textContent=fecha;document.getElementById('comCuerpo').textContent=cuerpo.replace(/<[^>]*>/g,'');document.getElementById('modalComunicado').style.display='flex';}
