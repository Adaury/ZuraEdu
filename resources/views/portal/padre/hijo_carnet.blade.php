...
@section('title', 'Carnet+ · ' . $estudiante->nombres)

@section('sidebar')
    @include('portal.padre._sidebar', ['activeKey' => 'carnet', 'estudiante' => $estudiante])
@endsection
...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <div>
        <h5 class="fw-bold mb-0">Carnet+ · {{ $estudiante->nombres }}</h5>
...
<div class="text-center py-5">
    ...
    <p class="text-muted small">El carnet digital de {{ $estudiante->nombres }} aún no ha sido emitido.<br>Contacta con la administración.</p>
</div>
@else
...
<div class="row g-4">
    ...
    <div class="col-lg-5">
        ...
        <div class="card border-0 shadow" style="border-radius:20px;overflow:hidden;background:linear-gradient(135deg,#0ea5e9,#6366f1);">
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <div>
                        <div class="text-white fw-bold" style="font-size:1rem;line-height:1.2;">{{ $estudiante->nombres }} {{ $estudiante->apellidos }}</div>
                        @if($matricula)
        ...
        <div class="card border-0 shadow-sm mt-3" style="border-radius:16px;">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-3 text-muted" style="font-size:.72rem;">
                    <i class="bi bi-shield-lock me-1"></i>Código QR del estudiante para entrada
                </div>
            </div>
        </div>
        @else
        <div class="alert alert-warning border-0 shadow-sm mt-3" style="border-radius:14px;">
            ...
            El carnet está <strong>{{ $carnet->estado }}</strong>. Contacta con administración.
        </div>
        @endif
    </div>
