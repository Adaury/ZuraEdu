...
@section('title', 'Observaciones de ' . $estudiante->nombres)

@section('sidebar')
    @include('portal.padre._sidebar', ['activeKey' => 'observaciones', 'estudiante' => $estudiante])
@endsection
...
<div class="prt-page-header">
    <div>
        <h4 class="prt-page-title">
            <i class="bi bi-chat-square-text me-2"></i>Observaciones — {{ $estudiante->nombre_completo }}
        </h4>
        @if($matricula)
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('portal.padre.hijo.observaciones.pdf', $estudiante) }}" target="_blank" class="btn btn-sm btn-danger">
            <i class="bi bi-file-earmark-pdf me-1"></i>PDF
        </a>
        <a href="{{ route('portal.padre.hijo.observaciones.excel', $estudiante) }}" class="btn btn-sm btn-success">
...
<div class="card border-0 shadow-sm">
    <div class="card-body text-center py-5 text-muted">
        ...
        <p class="mt-3 mb-0">No hay observaciones registradas.</p>
    </div>
</div>
@else
