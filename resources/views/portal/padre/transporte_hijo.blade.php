...
@section('title', 'Transporte — ' . $estudiante->nombres)

@section('sidebar')
    @include('portal.padre._sidebar', ['activeKey' => 'transporte', 'estudiante' => $estudiante])
@endsection
...
<div class="mb-4 p-4" style="background:linear-gradient(135deg,#0369a1,#38bdf8);border-radius:16px;position:relative;overflow:hidden;">
    ...
    <div style="position:relative;z-index:1;">
        <h4 class="text-white fw-bold mb-1"><i class="bi bi-bus-front-fill me-2"></i>Ruta de Transporte</h4>
...
<div class="text-center py-5">
    ...
    <h6 class="text-muted">Este estudiante no tiene una ruta de transporte asignada</h6>
    <p class="text-muted small">Si necesita el servicio de transporte escolar, comuníquese con la administración.</p>
</div>
@else
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div style="font-size:.72rem;text-transform:uppercase;letter-spacing:.05em;color:#6b7280;font-weight:600;">Parada Asignada</div>
        ...
        <div style="position:relative;">
            ...
            <div class="d-flex gap-3 mb-3">
                ...
                <div class="pb-1 {{ $esMiParada ? 'fw-semibold' : '' }}" style="font-size:.88rem;color:{{ $esMiParada ? '#1e293b' : '#64748b' }};">
                    ...
                    @if($esMiParada)
                    <span class="badge ms-2" style="background:#ede9fe;color:#7c3aed;font-size:.65rem;">Parada de {{ $estudiante->nombres }}</span>
                    @endif
