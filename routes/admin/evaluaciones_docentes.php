...
Route::middleware('can:gestionar-docentes')->group(function () {
    ...
    Route::get('evaluaciones-docentes/lista-excel',          [EvaluacionDocenteController::class, 'listaExcel'])->name('evaluaciones-docentes.lista-excel');
    Route::get('evaluaciones-docentes/lista-pdf',            [EvaluacionDocenteController::class, 'listaPdf'])->name('evaluaciones-docentes.lista-pdf');
