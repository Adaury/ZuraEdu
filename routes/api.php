...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'api.tenant', 'throttle:120,1'])->group(function () {
        ...
        Route::prefix('docente')->name('api.docente.')->middleware('can:acceso-docente-api')->group(function () {
        ...
        Route::get('docente/mis-evaluaciones',      [\App\Http\Controllers\Api\EvaluacionesDocenteApiController::class, 'misEvaluaciones'])->middleware('can:acceso-docente-api')->name('api.docente.mis-evaluaciones');

        // Reuniones del docente
        Route::get('docente/mis-reuniones',         [\App\Http\Controllers\Api\ReunionesApiController::class, 'misReuniones'])->middleware('can:acceso-docente-api')->name('api.docente.mis-reuniones');
